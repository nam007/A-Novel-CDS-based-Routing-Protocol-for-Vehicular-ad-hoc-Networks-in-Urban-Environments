...
int BasicSafetyMessage::getID() const
{
    return this->ID;
}

void BasicSafetyMessage::setID(int ID)
{
    this->ID = ID;
}

double BasicSafetyMessage::getX() const
{
    return this->x;
}

void BasicSafetyMessage::setX(double x)
{
    this->x = x;
}

double BasicSafetyMessage::getY() const
{
    return this->y;
}

void BasicSafetyMessage::setY(double y)
{
    this->y = y;
}

double BasicSafetyMessage::getSF() const
{
    return this->SF;
}

void BasicSafetyMessage::setSF(double SF)
{
    this->SF = SF;
}

const char * BasicSafetyMessage::getRid() const
{
    return this->rid.c_str();
}

void BasicSafetyMessage::setRid(const char * rid)
{
    this->rid = rid;
}
...
int BasicSafetyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='S' && strcmp(fieldName, "SF")==0) return base+5;
    if (fieldName[0]=='r' && strcmp(fieldName, "rid")==0) return base+6;
...
std::string BasicSafetyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return double2string(pp->getSF());
        case 6: return oppstring2string(pp->getRid());
        default: return "";
    }
}
...
bool BasicSafetyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 5: pp->setSF(string2double(value)); return true;
        case 6: pp->setRid((value)); return true;
